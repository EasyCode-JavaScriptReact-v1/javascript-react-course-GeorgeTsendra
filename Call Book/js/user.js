...
let i = 0;
let optionsLine = (text, className) => {
...
let addUserPageOutput = () => {
  ...
  main.innerHTML += `<header class="header">
        ...
        ${optionsLine(["massege","call","video","mail"],
        ...
        ${optionsTableuOtpu(["Notes" , "Send message","Share contact","Add to favorites",
